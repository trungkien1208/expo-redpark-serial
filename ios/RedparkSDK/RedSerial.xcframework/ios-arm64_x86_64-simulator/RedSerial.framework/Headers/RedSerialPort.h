...
enum
{
    ...
    kFwUpdateUnsupportedModel = 0x86
    
};

// returns version installed on connected device
-(NSString *) getDeviceFirmwareVersion;

// returns version available to be installed
-(NSString *) getAvailableFirmwareVersion;
